 ...
 */
public abstract class ReadSpeed extends 
        JointProperty.ReadOnly<NormalizedDouble> {
    /**
     * JointProperty Property Name
     */
    public final static String PROPERTY_NAME = "speed";
    /**
     * Name used for display purposes
     */
    public final static String DISPLAY_NAME = "Speed";
