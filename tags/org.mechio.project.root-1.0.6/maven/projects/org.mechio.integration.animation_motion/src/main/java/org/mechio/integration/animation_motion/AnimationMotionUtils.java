...
public class AnimationMotionUtils {
    private final static Logger theLogger = Logger.getLogger(AnimationMotionUtils.class.getName());
...
//        }
    ...
    private static ServiceRegistration registerAnimationPlayer(
        ...
        theLogger.log(Level.INFO, 
                "OSGiAnimationPlayer Service Registered Successfully.");
        return reg;
    }
    ...
    private static ServiceRegistration registerAnimationEditListener(
        ...
        theLogger.log(Level.INFO, 
                "AnimationEditFrameSource Service Registered Successfully.");
        return reg;
    }
    ...
    private static ServiceRegistration registerJointSnapshotAdder(
        ...
        theLogger.log(Level.INFO, 
                "JointSnapshot Service Registered Successfully.");
        return reg;
    }
}
