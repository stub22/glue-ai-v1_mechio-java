...
public class DynamixelController extends SerialServoController<
    ...
    private final static Logger theLogger = Logger.getLogger(DynamixelController.class.getName());
    /**
        ...
        for(ServoConfig<DynamixelServo.Id> param : myConfig.getServoConfigs().values()){
            ...
            if(!ping(id)){
                ...
                theLogger.log(Level.WARNING,
                        "Unable to ping Dynamixel {0}.",
                        new Object[]{param.getServoId()});
                continue;
            }
            ...
            ServoId<DynamixelServo.Id> servoId = 
                    new ServoId<DynamixelServo.Id>(getId(), sId);
    ...
    public boolean moveServos(
        ...
        List<GoalUpdateValues<DynamixelServo.Id>> goals = 
                new ArrayList<GoalUpdateValues<DynamixelServo.Id>>(len);
     ...
     * @param deferred if true, data is written but the DynamixelServo state 
    ...
    public boolean connect() {
        ...
        if(connect){
            ...
            List<DynamixelServo.Id> ids = 
                    new ArrayList<DynamixelServo.Id>();
