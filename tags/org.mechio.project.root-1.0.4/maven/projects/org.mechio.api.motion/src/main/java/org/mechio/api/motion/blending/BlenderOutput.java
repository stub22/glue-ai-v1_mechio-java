 ...
 * @param <PosMap> PositionMap type used by this BlenderOutput
 * 
...
public interface BlenderOutput<PosMap extends JointPositionMap> {
     ...
     * @param lenMillisec duration of the output movement in milliseconds
     */
    public void write(PosMap positions, long lenMillisec);
    /**
     * Get the last output positions.
     * @return last output positions
     */
    public PosMap getPositions();
}
