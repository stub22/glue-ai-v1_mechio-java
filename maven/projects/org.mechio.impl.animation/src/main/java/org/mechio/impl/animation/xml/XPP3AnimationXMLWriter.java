...
import static org.mechio.api.animation.xml.AnimationXML.NAMESPACE;
...
public class XPP3AnimationXMLWriter implements AnimationFileWriter {
	private static final Logger theLogger = LoggerFactory.getLogger(XPP3AnimationXMLWriter.class);
