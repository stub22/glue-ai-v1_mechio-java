 ...
 */
public abstract class ReadTemperature extends 
        JointProperty.ReadOnly<Temperature> {
    /**
     * JointProperty Property Name
     */
    public final static String PROPERTY_NAME = "temperature";
    /**
     * Name used for display purposes
     */
    public final static String DISPLAY_NAME = "Temperature";
